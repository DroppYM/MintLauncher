...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    // Mint Launcher: background cat disabled by default (legacy MultiMC feature)
    {
    ...
    // load the news (must fetch; cached feed.xml may still be Prism/Pinecone from older builds)
    {
