...
Application::Application(int& argc, char** argv) : QApplication(argc, argv)
{
    ...
    // Initialize application settings
    {
        ...
        m_settings->registerSetting("MintSkinProxy", true);
    ...
    m_metaMirrorNetworkCheck = std::make_unique<MetaMirrorNetworkCheck>(m_network.get());
    connect(m_metaMirrorNetworkCheck.get(), &MetaMirrorNetworkCheck::shouldReloadNews, this, &Application::shouldReloadNews);
